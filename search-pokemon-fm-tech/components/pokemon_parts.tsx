...
export const PokemonHeader = React.memo(function PokemonHeader({ name, number }: PokemonHeaderProps) {
    return (
...
export const PokemonImage = React.memo(function PokemonImage({ image, name }: PokemonImageProps) {
    return (
...
export const PokemonTypes = React.memo(function PokemonTypes({ types }: PokemonTypesProps) {
    return (
...
export const PokemonStats = React.memo(function PokemonStats({ classification }: PokemonStatsProps) {
    return (
...
export const PokemonAttacks = React.memo(function PokemonAttacks({ attacks }: PokemonAttacksProps) {
    return (
...
export const PokemonEvolutions = React.memo(function PokemonEvolutions({ evolutions }: PokemonEvolutionsProps) {
...
export const PokemonPhysicalStats = React.memo(function PokemonPhysicalStats({ height, weight }: PokemonPhysicalStatsProps) {
    return (
...
export const PokemonCombatStats = React.memo(function PokemonCombatStats({ maxCP, maxHP, fleeRate }: PokemonCombatStatsProps) {
    return (
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-blue-50">
...
export const PokemonResistances = React.memo(function PokemonResistances({ resistant, weaknesses }: PokemonResistancesProps) {
    return (
